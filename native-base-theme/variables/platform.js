...
export default {
  ...
  toolbarDefaultBg: (platform === 'ios') ? '#2A2111' : '#3F51B5',
  toolbarHeight: (platform === 'ios') ? 80 : 56,
  ...
  toolbarDefaultBorder: (platform === 'ios') ? '#2A2111' : '#3F51B5',
  ...
  titleFontSize: (platform === 'ios') ? 20 : 19,
  subTitleFontSize: (platform === 'ios') ? 12 : 14,
  subtitleColor: (platform === 'ios') ? '#8e8e93' : '#FFF',

    // New Variable
  titleFontColor: (platform === 'ios') ? '#956C1F' : '#FFF',
